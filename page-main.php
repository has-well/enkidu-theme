    ...
    <section id="hero-section-2" class="w-screen px-6 md:px-10 p-4 lg:p-10 pb-4 sm:pb-8 bg-blue">
        <div class="container flex-col sm:flex-row flex justify-between md:w-full lg:w-11/12">
            <div class="flex justify-right flex-col items-start w-full md:w-1/2 sm-bordered">
                ...
                <p class="text-white md:w-full lg:w-60 pt-8 text-lg font-bold"><?php the_field('hero3-1'); ?></p>
            </div>
            <div class="flex justify-right flex-col items-start w-full md:w-1/2 lg:pl-0 md:pl-3 mt-10 sm:mt-0">
                ...
                <p class="text-white md:w-full lg:w-3/5 pt-8 text-lg font-bold"><?php the_field('hero4-1'); ?></p>
            </div>
        </div>
        <div class="container flex justify-center mt-8 lg:mt-32 lg:mb-8">
            <a href="https://fondy.ua" class="btn btn-yellow text-lg font-bold"><?php _e('Learn more', 'enkidu-v2'); ?></a>
        </div>
    </section>
    <section id="solution">
                        ...
                        <div class="flex items-start mb-3 flex-col pt-4 sm:pt-8">
                            ...
                            <div class="flex-grow">
                                <p class="leading-relaxed text-sm text-main_text">
                                    Access to supplier catalogs with all the necessary products.<br/>
                ...
                <div class="p-4 md:w-1/2 pb-2">
                    <div class="flex rounded-lg h-full md:p-2 lg:p-12 pb-2">
                        ...
                        <div class="flex items-start mb-3 flex-col pt-4 sm:pt-8">
                            ...
                            <div class="flex-grow">
                                <p class="leading-relaxed text-sm text-main_text">
                                    Day-to-day procurement activities<br/>
            ...
            <div class="flex flex-wrap -m-4 lg:-mt-10">
                <div class="p-4 pt-0 md:w-1/2">
                    <div class="flex rounded-lg h-full md:p-2 lg:p-12 lg:pt-0">
                        ...
                        <div class="flex items-start mb-3 flex-col pt-4 sm:pt-8">
                            ...
                            <div class="flex-grow">
                                <p class="leading-relaxed text-sm text-main_text">
                                    Accessible a large audience of suppliers in EU and World.<br/>
                ...
                <div class="p-4 pt-0 md:w-1/2">
                    <div class="flex rounded-lg h-full md:p-2 lg:p-12 lg:pt-0">
                        ...
                        <div class="flex items-start mb-3 flex-col pt-4 sm:pt-8">
                            <h2 class="text-xl sm:text-2xl title-font font-medium pb-6 font-bold">Invocies workflow</h2>
                            <div class="flex-grow">
                                <p class="leading-relaxed text-sm text-main_text">
                                    Exchange of electronic transactional documents with suppliers<br/>
